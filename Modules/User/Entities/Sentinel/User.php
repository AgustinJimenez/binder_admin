...
class User extends EloquentUser implements UserInterface, AuthenticatableContract
{
    ...
    {
        return $this->belongsTo('Modules\Colegios\Entities\Colegio', 'colegio_id', 'id');
    }
    ...
    public function html_edit_button($title = "USUARIO", $class = "btn btn-primary")
    {
        return '<br><a class="' . $class . '" href="' . route('admin.user.custom-user.edit', [$this->id]) . '">' . $title . '</a>';
    }
