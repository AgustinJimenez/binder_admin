...
class RolesController extends BaseUserModuleController
{
    ...
    {
        if( !\EloquentRole::where('name', 'Administrador')->exists() )
            \EloquentRole::create(['name' => 'Administrador', 'slug' => 'administrador']);

        if( !\EloquentRole::where('name', 'Responsable')->exists() )
            \EloquentRole::create(['name' => 'Responsable', 'slug' => 'responsable']);
        
        if( !\EloquentRole::where('name', 'Alumno')->exists() )
            \EloquentRole::create(['name' => 'Alumno', 'slug' => 'alumno']);
