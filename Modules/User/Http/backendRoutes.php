...
$router->group(['prefix' => '/user'], function (Router $router) {
    ...
    *   Custom Users
    */
    $router->get('custom-users', [
        'as' => 'admin.user.custom-user.index',
        'uses' => 'CustomUserController@index',
        'middleware' => 'can:user.custom-user.index',
    ]);
    $router->get('custom-users/create', [
        'as' => 'admin.user.custom-user.create',
        'uses' => 'CustomUserController@create',
        'middleware' => 'can:user.custom-user.create',
    ])->middleware('verifyColegioToken');

    $router->post('custom-users', [
        'as' => 'admin.user.custom-user.store',
        'uses' => 'CustomUserController@store',
        'middleware' => 'can:user.custom-user.create',
    ])->middleware('verifyColegioToken');

    $router->get('custom-users/{users}/edit', [
        'as' => 'admin.user.custom-user.edit',
        'uses' => 'CustomUserController@edit',
        'middleware' => 'can:user.custom-user.edit',
    ]);
    
    $router->put('custom-users/{users}/edit', [
        'as' => 'admin.user.custom-user.update',
        'uses' => 'CustomUserController@update',
        'middleware' => 'can:user.custom-user.edit',
    ]);
    // $router->get('custom-users/{users}/sendResetPassword', [
    //     'as' => 'admin.user.custom-user.sendResetPassword',
    //     'uses' => 'CustomUserController@sendResetPassword',
    //     'middleware' => 'can:user.users.edit',
    // ]);
    $router->delete('custom-users/{users}', [
        'as' => 'admin.user.custom-user.destroy',
        'uses' => 'CustomUserController@destroy',
        'middleware' => 'can:user.custom-user.destroy',
    ]);
    /****/
