...
Form::macro('normalSelect', function ($name, $title, ViewErrorBag $errors, array $choice, $object = null, array $options = []) {
    ...
    /* Bootstrap default class */
    $array_option = ['class' => 'form-control', 'id' => $name];
 ...
 * @return HtmlString
 */
Form::macro('requiredInput', function ($name, $title, ViewErrorBag $errors, $object = null, array $options = []) {
    if (array_key_exists('required', $options))
        unset($options['required']);

    $options = array_merge(['class' => 'form-control', 'placeholder' => $title, 'required' => 'required'], $options);
 ...
 * @return HtmlString
 */
Form::macro('requiredTextarea', function ($name, $title, ViewErrorBag $errors, $object = null, array $options = []) {
    if (array_key_exists('required', $options))
        unset($options['required']);
 ...
 * @return HtmlString
 */
Form::macro('requiredCheckbox', function ($name, $title, ViewErrorBag $errors, $object = null) {
    if (array_key_exists('required', $options))
        unset($options['required']);
 ...
 * @return HtmlString
 */
Form::macro('requiredSelect', function ($name, $title, ViewErrorBag $errors, array $choice, $object = null, array $options = []) {
    if (array_key_exists('required', $options))
        unset($options['required']);
    ...
    /* Bootstrap default class */
    $array_option = ['class' => 'form-control', 'id' => $name, 'required' => 'required'];
