...
<head>
    ...
    {!! Theme::style('vendor/jquery-confirm/css/jquery-confirm.css') !!}
...
{!! Theme::script('vendor/jquery-confirm/js/jquery-confirm.js') !!}
...
<script type="text/javascript">
    $(document).ready(function()
    {
        $("input").each(function()
        {
            $(this).attr("oninvalid", "this.setCustomValidity('Por favor, completar el campo')").attr("oninput", "setCustomValidity('')");
        });
    });
</script>
